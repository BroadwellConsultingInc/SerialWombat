...
${OBJECTDIR}/i2cController.o: i2cController.c  .generated_files/652eeb199dc154e09d766446734ed3ebef33957b.flag .generated_files/8ab545786e3347d84c0f15a0012cf6e8148ea312.flag
	@${MKDIR} "${OBJECTDIR}" 
...
${OBJECTDIR}/i2cController.o: i2cController.c  .generated_files/7987e51342a8197bb8ef3366a9532e574f5401eb.flag .generated_files/8ab545786e3347d84c0f15a0012cf6e8148ea312.flag
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/i2cController.o.d 
	@${RM} ${OBJECTDIR}/i2cController.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  i2cController.c  -o ${OBJECTDIR}/i2cController.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MP -MMD -MF "${OBJECTDIR}/i2cController.o.d"      -mno-eds-warn  -g -omf=elf -DXPRJ_default=$(CND_CONF)  -legacy-libc  $(COMPARISON_BUILD)  -I"../../SerialWombatCommon" -mlarge-code -O2 -I"pic24fj256ga702" -I"pic24fj256ga702/mcc_generated_files" -I"." -msmart-io=1 -Wall -msfr-warn=off    -mdfp="${DFP_DIR}/xc16"
