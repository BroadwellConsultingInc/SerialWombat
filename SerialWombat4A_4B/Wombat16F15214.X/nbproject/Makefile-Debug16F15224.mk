...
ifeq "$(wildcard nbproject/Makefile-local-Debug16F15224.mk)" "nbproject/Makefile-local-Debug16F15224.mk"
include nbproject/Makefile-local-Debug16F15224.mk
endif
endif
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-Debug16F15224.mk dist/${CND_CONF}/${IMAGE_TYPE}/Wombat16F15214.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
dist/${CND_CONF}/${IMAGE_TYPE}/Wombat16F15214.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/Wombat16F15214.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -DXPRJ_Debug16F15224=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -mrom=-FFF-FFF -Os -fasmfile -maddrqual=require -DUARTWOMBAT -xassembler-with-cpp -I"." -I"../../SerialWombatCommon" -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file -mcodeoffset=0x140  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -std=c99 -gdwarf-3 -mstack=compiled:auto:auto --msgdisable=520        $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/Wombat16F15214.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
...
dist/${CND_CONF}/${IMAGE_TYPE}/Wombat16F15214.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    ../../../../PIC16F15214Bootloader/BootloaderPIC16F15214/BootloaderPIC16F15214.X/dist/default/production/BootloaderPIC16F15214.X.production.hex
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=dist/${CND_CONF}/${IMAGE_TYPE}/Wombat16F15214.X.${IMAGE_TYPE}.map  -DXPRJ_Debug16F15224=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -mrom=-FFF-FFF -Os -fasmfile -maddrqual=require -DUARTWOMBAT -xassembler-with-cpp -I"." -I"../../SerialWombatCommon" -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file -mcodeoffset=0x140  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -std=c99 -gdwarf-3 -mstack=compiled:auto:auto --msgdisable=520     $(COMPARISON_BUILD) -Wl,--memorysummary,dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -o dist/${CND_CONF}/${IMAGE_TYPE}/Wombat16F15214.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Debug16F15224
	${RM} -r dist/Debug16F15224
